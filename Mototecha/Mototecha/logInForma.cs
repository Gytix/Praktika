...
namespace Mototecha
{
    public partial class logInForma : Form
    {
        ...
        private void Button1_Click(object sender, EventArgs e)
        {
            ...
            duombaze.Open();
            string querry = "SELECT * FROM `vartotojas` WHERE PrisijungimoVardas = '" + tBvardas.Text.Trim() + 
                                        "' AND PrisijungimoSlaptazodis = '" + tBslaptazodis.Text.Trim() + "'";
            ...
            if (dtbl.Rows.Count == 1)
            {
                ...
                if (Vartotojas.vardas == "Gytyx" && Vartotojas.slaptazodis == "qwerty")
                {
                    privilegija = 1;
                }
                else
